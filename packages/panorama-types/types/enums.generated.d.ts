...
declare enum modifierfunction {
     ...
     */
    MODIFIER_PROPERTY_RESPAWNTIME_PERCENTAGE = 116,
    /**
     ...
     */
    MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK_UNAVOIDABLE_PRE_ARMOR = 132,
    /**
     ...
     */
    MODIFIER_PROPERTY_ABSORB_SPELL = 137,
    /**
     ...
     */
    MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PHYSICAL = 147,
    /**
     * Method Name: `GetAbsoluteNoDamageMagical`
     */
    MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_MAGICAL = 148,
    /**
     * Method Name: `GetAbsoluteNoDamagePure`
     */
    MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PURE = 149,
    /**
     ...
     */
    MODIFIER_EVENT_ON_SPELL_TARGET_READY = 172,
    /**
     ...
     */
    MODIFIER_EVENT_ON_ATTACK_FAIL = 177,
    /**
     ...
     */
    MODIFIER_EVENT_ON_ATTACK_ALLIED = 178,
    /**
     ...
     */
    MODIFIER_EVENT_ON_ABILITY_START = 182,
    /**
     * Method Name: `OnAbilityExecuted`
     */
    MODIFIER_EVENT_ON_ABILITY_EXECUTED = 183,
    /**
     * Method Name: `OnAbilityFullyCast`
     */
    MODIFIER_EVENT_ON_ABILITY_FULLY_CAST = 184,
    /**
     * Method Name: `OnBreakInvisibility`
     */
    MODIFIER_EVENT_ON_BREAK_INVISIBILITY = 185,
    /**
     * Method Name: `OnAbilityEndChannel`
     */
    MODIFIER_EVENT_ON_ABILITY_END_CHANNEL = 186,
     ...
     */
    MODIFIER_EVENT_ON_ATTACKED = 196,
    /**
     * Method Name: `OnDeath`
     */
     ...
     */
    MODIFIER_EVENT_ON_HERO_KILLED = 206,
    /**
     ...
     */
    MODIFIER_EVENT_ON_BUILDING_KILLED = 208,
    /**
     ...
     */
    MODIFIER_EVENT_ON_ATTACK_FINISHED = 234,
    /**
...
declare enum DOTAKeybindCommand_t {
    ...
    DOTA_KEYBIND_COMBATLOG_TOGGLE = 133,
    DOTA_KEYBIND_SCREENSHOT = 134,
    DOTA_KEYBIND_ESCAPE = 135,
    DOTA_KEYBIND_CONSOLE = 136,
    DOTA_KEYBIND_DEATH_SUMMARY = 137,
    DOTA_KEYBIND_LEARN_ABILITIES = 138,
    DOTA_KEYBIND_LEARN_STATS = 139,
    DOTA_KEYBIND_ACTIVATE_GLYPH = 140,
    DOTA_KEYBIND_ACTIVATE_RADAR = 141,
    DOTA_KEYBIND_PURCHASE_QUICKBUY = 142,
    DOTA_KEYBIND_PURCHASE_STICKY = 143,
    DOTA_KEYBIND_GRAB_STASH_ITEMS = 144,
    DOTA_KEYBIND_TOGGLE_AUTOATTACK = 145,
    DOTA_KEYBIND_TAUNT = 146,
    DOTA_KEYBIND_SHOP_CONSUMABLES = 147,
    DOTA_KEYBIND_SHOP_ATTRIBUTES = 148,
    DOTA_KEYBIND_SHOP_ARMAMENTS = 149,
    DOTA_KEYBIND_SHOP_ARCANE = 150,
    DOTA_KEYBIND_SHOP_BASICS = 151,
    DOTA_KEYBIND_SHOP_SUPPORT = 152,
    DOTA_KEYBIND_SHOP_CASTER = 153,
    DOTA_KEYBIND_SHOP_WEAPONS = 154,
    DOTA_KEYBIND_SHOP_ARMOR = 155,
    DOTA_KEYBIND_SHOP_ARTIFACTS = 156,
    DOTA_KEYBIND_SHOP_SIDE_PAGE_1 = 157,
    DOTA_KEYBIND_SHOP_SIDE_PAGE_2 = 158,
    DOTA_KEYBIND_SHOP_SECRET = 159,
    DOTA_KEYBIND_SHOP_SEARCHBOX = 160,
    DOTA_KEYBIND_SHOP_SLOT_1 = 161,
    DOTA_KEYBIND_SHOP_SLOT_2 = 162,
    DOTA_KEYBIND_SHOP_SLOT_3 = 163,
    DOTA_KEYBIND_SHOP_SLOT_4 = 164,
    DOTA_KEYBIND_SHOP_SLOT_5 = 165,
    DOTA_KEYBIND_SHOP_SLOT_6 = 166,
    DOTA_KEYBIND_SHOP_SLOT_7 = 167,
    DOTA_KEYBIND_SHOP_SLOT_8 = 168,
    DOTA_KEYBIND_SHOP_SLOT_9 = 169,
    DOTA_KEYBIND_SHOP_SLOT_10 = 170,
    DOTA_KEYBIND_SHOP_SLOT_11 = 171,
    DOTA_KEYBIND_SHOP_SLOT_12 = 172,
    DOTA_KEYBIND_SHOP_SLOT_13 = 173,
    DOTA_KEYBIND_SHOP_SLOT_14 = 174,
    DOTA_KEYBIND_SPEC_CAMERA_UP = 175,
    DOTA_KEYBIND_SPEC_CAMERA_DOWN = 176,
    DOTA_KEYBIND_SPEC_CAMERA_LEFT = 177,
    DOTA_KEYBIND_SPEC_CAMERA_RIGHT = 178,
    DOTA_KEYBIND_SPEC_CAMERA_GRIP = 179,
    DOTA_KEYBIND_SPEC_CAMERA_SAVED_POSITION_1 = 180,
    DOTA_KEYBIND_SPEC_CAMERA_SAVED_POSITION_2 = 181,
    DOTA_KEYBIND_SPEC_CAMERA_SAVED_POSITION_3 = 182,
    DOTA_KEYBIND_SPEC_CAMERA_SAVED_POSITION_4 = 183,
    DOTA_KEYBIND_SPEC_CAMERA_SAVED_POSITION_5 = 184,
    DOTA_KEYBIND_SPEC_CAMERA_SAVED_POSITION_6 = 185,
    DOTA_KEYBIND_SPEC_CAMERA_SAVED_POSITION_7 = 186,
    DOTA_KEYBIND_SPEC_CAMERA_SAVED_POSITION_8 = 187,
    DOTA_KEYBIND_SPEC_CAMERA_SAVED_POSITION_9 = 188,
    DOTA_KEYBIND_SPEC_CAMERA_SAVED_POSITION_10 = 189,
    DOTA_KEYBIND_SPEC_UNIT_SELECT = 190,
    DOTA_KEYBIND_SPEC_HERO_SELECT = 191,
    DOTA_KEYBIND_SPEC_PAUSE = 192,
    DOTA_KEYBIND_SPEC_CHAT = 193,
    DOTA_KEYBIND_SPEC_SCOREBOARD = 194,
    DOTA_KEYBIND_SPEC_INCREASE_REPLAY_SPEED = 195,
    DOTA_KEYBIND_SPEC_DECREASE_REPLAY_SPEED = 196,
    DOTA_KEYBIND_SPEC_STATS_HARVEST = 197,
    DOTA_KEYBIND_SPEC_STATS_ITEM = 198,
    DOTA_KEYBIND_SPEC_STATS_GOLD = 199,
    DOTA_KEYBIND_SPEC_STATS_XP = 200,
    DOTA_KEYBIND_SPEC_STATS_FANTASY = 201,
    DOTA_KEYBIND_SPEC_STATS_WINCHANCE = 202,
    DOTA_KEYBIND_SPEC_FOW_TOGGLEBOTH = 203,
    DOTA_KEYBIND_SPEC_FOW_TOGGLERADIENT = 204,
    DOTA_KEYBIND_SPEC_FOW_TOGGLEDIRE = 205,
    DOTA_KEYBIND_SPEC_OPEN_BROADCASTER_MENU = 206,
    DOTA_KEYBIND_SPEC_DROPDOWN_KDA = 207,
    DOTA_KEYBIND_SPEC_DROPDOWN_LASTHITS_DENIES = 208,
    DOTA_KEYBIND_SPEC_DROPDOWN_LEVEL = 209,
    DOTA_KEYBIND_SPEC_DROPDOWN_XP_PER_MIN = 210,
    DOTA_KEYBIND_SPEC_DROPDOWN_GOLD = 211,
    DOTA_KEYBIND_SPEC_DROPDOWN_TOTALGOLD = 212,
    DOTA_KEYBIND_SPEC_DROPDOWN_GOLD_PER_MIN = 213,
    DOTA_KEYBIND_SPEC_DROPDOWN_BUYBACK = 214,
    DOTA_KEYBIND_SPEC_DROPDOWN_NETWORTH = 215,
    DOTA_KEYBIND_SPEC_DROPDOWN_FANTASY = 216,
    DOTA_KEYBIND_SPEC_DROPDOWN_SORT = 217,
    DOTA_KEYBIND_SPEC_DROPDOWN_CLOSE = 218,
    DOTA_KEYBIND_SPEC_FOCUS_PLAYER_1 = 219,
    DOTA_KEYBIND_SPEC_FOCUS_PLAYER_2 = 220,
    DOTA_KEYBIND_SPEC_FOCUS_PLAYER_3 = 221,
    DOTA_KEYBIND_SPEC_FOCUS_PLAYER_4 = 222,
    DOTA_KEYBIND_SPEC_FOCUS_PLAYER_5 = 223,
    DOTA_KEYBIND_SPEC_FOCUS_PLAYER_6 = 224,
    DOTA_KEYBIND_SPEC_FOCUS_PLAYER_7 = 225,
    DOTA_KEYBIND_SPEC_FOCUS_PLAYER_8 = 226,
    DOTA_KEYBIND_SPEC_FOCUS_PLAYER_9 = 227,
    DOTA_KEYBIND_SPEC_FOCUS_PLAYER_10 = 228,
    DOTA_KEYBIND_SPEC_COACH_VIEWTOGGLE = 229,
    DOTA_KEYBIND_INSPECTHEROINWORLD = 230,
    DOTA_KEYBIND_CAMERA_ZOOM_IN = 231,
    DOTA_KEYBIND_CAMERA_ZOOM_OUT = 232,
    DOTA_KEYBIND_CONTROL_GROUPCYCLEPREV = 233,
    DOTA_KEYBIND_DOTA_ALT = 234,
    DOTA_KEYBIND_COUNT = 235,
}
