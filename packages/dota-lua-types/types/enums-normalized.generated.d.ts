...
declare const enum GameActivity {
    ...
    DOTA_VOODOO_REST = 1778,
    DOTA_RUN_ALT = 1779,
    DOTA_RELAX_IN = 1783,
    DOTA_RELAX_OUT = 1784,
    DOTA_CAST_FENCE = 1785,
    DOTA_SPWN = 1786,
    DOTA_RADIANT_CREEP_HAMMER = 1788,
    DOTA_CYCLONE = 1789,
    DOTA_IMPALE = 1790,
    DOTA_TORRENT = 1791,
}
...
declare const enum SourceEngineAnimationEvent {
    ...
    CL_SUPPRESS_EVENTS_WITH_TAG = 32,
    CL_HIDE_PARTICLE_EFFECT = 33,
    CL_SHOW_PARTICLE_EFFECT = 34,
    CL_ADD_PARTICLE_EFFECT_CP = 35,
    CL_SPEECH = 36,
    CL_PANORAMA_EVENT = 37,
    CL_DOTA_PLAY_STATUS_EFFECT = 38,
    CL_DOTA_STOP_STATUS_EFFECT = 39,
    CL_DOTA_NPC_CREATE_PARTICLE_EFFECT = 40,
    CL_DOTA_RUBICK_ARCANA_CREATE_PARTICLE_EFFECT = 41,
    DOTA_PET_ITEM_PICKUP = 42,
    DOTA_PET_ITEM_DROP = 43,
    DOTA_SUPPRESS_CONSTANT_LAYER = 44,
    DOTA_PLAY_SOUND_ATTACK_SPECIAL = 45,
    DOTA_CREATE_CLINKZ_ATTACK = 46,
    DOTA_PLAY_SOUND_ATTACK_BACKSTAB = 47,
    DOTA_DIE_PHANTOM_DEATH_PARTICLES = 48,
    DOTA_SWITCH_ATTACK_COMBO = 49,
    EF_NODRAW = 50,
    EF_DRAW = 51,
    DOTA_PLAY_SOUND_ATTACK = 52,
}
